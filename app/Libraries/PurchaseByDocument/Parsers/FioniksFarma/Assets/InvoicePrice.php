...
class InvoicePrice
{
    ...
    public function execute()
    {
        ...
        $pattern = [
            ...
            'СУМА ЗА ПЛАЩАНЕ ЛВ' => '/СУМА ЗА ПЛАЩАНЕ ЛВ\s*:\s*([^\n\r]+)/',
            'Словом' => '/Словом\s*:\s*([^\n\r]+)/',
        ...
        if(isset($this->parsedInfo['СУМА ЗА ПЛАЩАНЕ ЛВ'])) {
            $this->parsedInfo['СУМА ЗА ПЛАЩАНЕ'] = $this->parsedInfo['СУМА ЗА ПЛАЩАНЕ ЛВ'];
            unset($this->parsedInfo['СУМА ЗА ПЛАЩАНЕ ЛВ']);
        }
    }
