let comparisonTaxBases;

class ComparisonTaxBases {
    constructor() {
        this.dataTables();
        this.datePicker();
        this.events();
    ...
    events() {
        $('#view-btn').on('click', function () {
            ...
            window.location.href = `/reference/comparison-of-tax-bases/${urlParams}`;
        });
...
$(document).ready(function () {
    comparisonTaxBases = new ComparisonTaxBases();
});
